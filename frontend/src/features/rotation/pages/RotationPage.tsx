  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <main className="mx-auto max-w-2xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <h1 className="mt-3 text-4xl font-bold tracking-tight text-foreground">Entenda o rodízio</h1>
        ...
        <section className="mt-8 rounded-xl border border-accent/30 bg-accent-subtle p-5" aria-labelledby="rotation-tip-title">
          <h2 className="text-lg font-semibold text-foreground" id="rotation-tip-title">
            Dica importante
          </h2>
        ...
        <section className="mt-4 rounded-xl border border-info-border bg-info-subtle p-5" aria-labelledby="position-tip-title">
          <h2 className="text-lg font-semibold text-foreground" id="position-tip-title">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <button
            className="rounded-lg border border-border bg-surface px-4 py-3 font-semibold text-foreground transition hover:bg-surface-raised disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <section className="mt-12" aria-labelledby="position-scenarios-title">
          <h2 className="text-2xl font-bold text-foreground" id="position-scenarios-title">
        ...
        <section className="mt-8 rounded-xl border border-border bg-surface p-5" aria-labelledby="fault-difference-title">
          <h2 className="text-lg font-semibold text-foreground" id="fault-difference-title">
            Falta de posição ou falta de rodízio?
          </h2>
          <dl className="mt-4 space-y-4 leading-7 text-muted">
            <div>
              <dt className="font-semibold text-foreground">Falta de posição</dt>
              <dd>As relações entre atletas da equipe receptora estão incorretas no saque.</dd>
            </div>
            <div>
              <dt className="font-semibold text-foreground">Falta de rodízio</dt>
        ...
        <footer className="mt-10 border-t border-border pt-6 text-sm leading-6 text-muted">
          <p>
            Fonte:{' '}
            <a
              className="font-semibold text-accent underline hover:text-accent-strong"
